...
<br>
	...
	<%
		    	...
		    	String sqll = "SELECT order_details.quantity, customer_details.Name, product_details.product_name, product_details.product_price FROM order_details,product_details,customer_details WHERE order_details.prod_ID=product_details.product_id and order_details.cust_ID=customer_details.customer_id";
		    	ResultSet rss = conn.createStatement().executeQuery(sqll);
        %>
                <table border="1" align="center">
		<tr align="center">
			<th>Order ID</th>
		...
		<%  int id = 1;
                    while(rss.next())	{
		    			...
		    			String pname = rss.getString("product_name");
		    			double price = rss.getDouble("product_price");
